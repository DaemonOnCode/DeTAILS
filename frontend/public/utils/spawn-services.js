...
const spawnServices = async () => {
    try {
        await Promise.all([
            spawnService(servicesConfig.chroma, config.mainWindow),
            spawnService(servicesConfig.backend, config.mainWindow),
            spawnService(servicesConfig.miscFrontend, config.mainWindow),
            spawnService(servicesConfig.ollama, config.mainWindow)
        ]);
