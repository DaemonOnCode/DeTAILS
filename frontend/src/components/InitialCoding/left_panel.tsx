...
const LeftPanel: FC<LeftPanelProps> = ({
  ...
  <div className="w-1/4 bg-gray-100 p-4 border-r overflow-y-auto">
    <div className="flex space-x-4 mb-4">
      <button
        className={`font-semibold ${selectedTab === "data" ? "text-blue-500 border-b-2 border-blue-500" : "text-gray-600"}`}
        onClick={() => setSelectedTab("data")}
      >
        Data
      </button>
      <button
        className={`font-semibold ${selectedTab === "codes" ? "text-blue-500 border-b-2 border-blue-500" : "text-gray-600"}`}
