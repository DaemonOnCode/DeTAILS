...
export const LOADER_TO_ROUTE_MAP: Record<string, string> = {
    ...
    [`/${ROUTES.CODING}/loader/${CODING_LOADER_ROUTES.DEDUCTIVE_CODING_LOADER}?text=Initial+Coding+in+Progress`]:
        CODING_PAGE_ROUTES.CODEBOOK_CREATION,
    [`/${ROUTES.CODING}/loader/${CODING_LOADER_ROUTES.DEDUCTIVE_CODING_LOADER}?text=Final+Coding+in+Progress`]:
