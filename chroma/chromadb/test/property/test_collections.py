...
class CollectionStateMachine(RuleBasedStateMachine):
    ...
    _model: Dict[str, Optional[custom_types.CollectionMetadata]]
    ...
    def get_or_create_coll(
        ...
        new_metadata: Optional[custom_types.Metadata],
    ) -> MultipleResults[strategies.ExternalCollection]:
    ...
    def modify_coll(
        self,
        coll: strategies.ExternalCollection,
        new_metadata: custom_types.Metadata,
    ...
    def set_model(
        self,
        name: str,
        metadata: Optional[custom_types.CollectionMetadata],
    ) -> None:
        model = self.model
        model[name] = metadata
