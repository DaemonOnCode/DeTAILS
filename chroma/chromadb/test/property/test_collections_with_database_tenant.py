...
class TenantDatabaseCollectionStateMachine(CollectionStateMachine):
    ...
    tenant_to_database_to_model: Dict[
        str, Dict[str, Dict[str, Optional[custom_types.CollectionMetadata]]]
    ]
    ...
    def get_tenant_model(
        self, tenant: str
    ) -> Dict[str, Dict[str, Optional[custom_types.CollectionMetadata]]]:
        return self.tenant_to_database_to_model[tenant]

    def set_tenant_model(
        self,
        tenant: str,
        model: Dict[str, Dict[str, Optional[custom_types.CollectionMetadata]]],
    ) -> None:
    ...
    def set_database_model_for_tenant(
        ...
        tenant: str,
        database: str,
        database_model: Dict[str, Optional[custom_types.CollectionMetadata]],
    ) -> None:
        self.tenant_to_database_to_model[tenant][database] = database_model

    @property
    def model(self) -> Dict[str, Optional[custom_types.CollectionMetadata]]:
