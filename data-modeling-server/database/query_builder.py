...
class QueryBuilder(Generic[T]):
    ...
    def reset(self) -> "QueryBuilder[T]":
        ...
        self.offset_clause = ""  # Reset offset_clause
        return self
    ...
    def find(self, filters: Optional[Dict[str, Any]] = None) -> Tuple[str, Tuple[Any, ...]]:
        ...
        # Updated to handle LIMIT and OFFSET together
        if self.limit_clause and self.offset_clause:
            ...
            # In SQLite, OFFSET without LIMIT requires LIMIT -1 to indicate no limit
